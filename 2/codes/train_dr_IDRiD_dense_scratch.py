...
val_ratio = 0.1
n_epochs = 400
schedules = {'lr':{'0':0.003, '100':0.0003, '200':0.00003, '300':0.00003}}
validation_epochs = range(0, 400, 1)
...
if FLAGS.load_model_dir:
    ...
    print "model loaded"
    network=model.dr_dense_from_scratch(network)
    print "dense layer initialized"
else:
