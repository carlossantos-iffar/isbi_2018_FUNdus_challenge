...
# set misc paths
fundus_dirs = ["../data/kaggle_DR_train/preprocessed", "../data/kaggle_DR_test/preprocessed"]
grade_path = "../data/all_labels.csv"
img_out_dir = "/nfs/jaemin/isbi/2/dr_jaemin_net/img_outputs"
model_out_dir = "/nfs/jaemin/isbi/2/models/dr_jaemin_net/"
