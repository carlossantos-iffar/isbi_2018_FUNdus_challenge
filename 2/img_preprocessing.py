...
def process(args):
    ...
    for filename in filenames:
        ...
        if "IDRiD_" in os.path.basename(out_file):
            img = img[:, 230:3730, ...]
        else:
            y_offset = int(40.*img.shape[0] / 1488)
            x_offset = int(400.*img.shape[1] / 2240)
            img = img[y_offset:-y_offset, x_offset:-x_offset, ...]
        # pad imgs
...
# dir_list = ["../data/Training_Set", "../data/messidor_data"]
dir_list = ["../data/messidor_data"]
