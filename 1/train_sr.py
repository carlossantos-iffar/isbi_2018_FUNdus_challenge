...
atrous_depth = depths[FLAGS.task]
...
# set misc paths
train_patch_size = (1280, 1280)  # cropped img size:  (2848, 3500)
scale_factor = train_patch_size[0] // 640

validation_patch_size = (1280, 1280)
img_out_template = "../segmentation_results/SR_{}_{}_cont" if FLAGS.load_model_dir else "../segmentation_results/SR_{}_{}"
model_out_template = "../models/SR_{}_{}_cont" if FLAGS.load_model_dir else "../models/SR_{}_{}"
img_out_dir = img_out_template.format(atrous_depth, FLAGS.task + "_loss_weight_divisor_" + str(FLAGS.loss_weight_divisor))
model_out_dir = model_out_template.format(atrous_depth, FLAGS.task + "_loss_weight_divisor_" + str(FLAGS.loss_weight_divisor))
...
home_dir = "../data/preprocessed_1280/"
AR = os.path.join(home_dir, "Apparent_Retinopathy")
if FLAGS.task == "EX":
    NAR = os.path.join(home_dir, "No_Apparent_Retinopathy_EX")
else:
    NAR = os.path.join(home_dir, "No_Apparent_Retinopathy_HE_MA_SE")
...
if FLAGS.load_model_dir:
    ...
    network = model.unet_atrous_sr(depths[FLAGS.task], atrous_depth, scale_factor, train_patch_size, FLAGS.loss_weight_divisor) 
